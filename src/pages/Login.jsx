...
export default function Login() {
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute top-1/4 -left-24 w-64 h-64 rounded-full opacity-15 animate-float pointer-events-none"
        style={{ background: 'radial-gradient(circle, #A78BFA, transparent 70%)' }}
        aria-hidden="true"
      />
      <div
        className="absolute bottom-1/4 -right-20 w-48 h-48 rounded-full opacity-10 animate-float pointer-events-none"
        style={{ background: 'radial-gradient(circle, #60A5FA, transparent 70%)', animationDelay: '4s' }}
        aria-hidden="true"
      />
      ...
      <div className="w-full max-w-sm relative z-10 animate-fade-up">
        ...
        <p className="text-gray-400 mb-7 font-body text-sm">Sign in to your finance dashboard</p>

        {infoMessage && (
          <div className="glass-card rounded-xl px-4 py-3 text-income text-sm mb-5 font-body">
            {infoMessage}
          </div>
        )}
        ...
        <p className="text-gray-500 text-sm text-center mt-6 font-body">
          ...
          <Link to="/signup" className="text-accent hover:text-white transition-colors font-semibold">
            Sign up
          </Link>
        </p>
      </div>
